...
$sql = "SELECT id, student_id, first_name, last_name, course, year_level, year_section FROM users WHERE student_id IS NOT NULL AND student_id != '' ORDER BY last_name ASC";
